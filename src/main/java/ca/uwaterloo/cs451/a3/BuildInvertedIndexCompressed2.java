...
public class BuildInvertedIndexCompressed2 extends Configured implements Tool {
  private static final Logger LOG = Logger.getLogger(BuildInvertedIndexCompressed2.class);
  ...
  private BuildInvertedIndexCompressed2() {}
  ...
  public int run(String[] argv) throws Exception {
    ...
    LOG.info("Tool: " + BuildInvertedIndexCompressed2.class.getSimpleName());
    LOG.info(" - input path: " + args.input);
    LOG.info(" - output path: " + args.output);
    LOG.info(" - number of reducers: " + args.numReducers);

    Job job = Job.getInstance(getConf());
    job.setJobName(BuildInvertedIndexCompressed2.class.getSimpleName());
    job.setJarByClass(BuildInvertedIndexCompressed2.class);
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new BuildInvertedIndexCompressed2(), args);
  }
}
