...
public class BooleanRetrievalCompressed2 extends Configured implements Tool {
  private MapFile.Reader[] indexFiles;
  private FSDataInputStream collection;
  private Stack<Set<Integer>> stack;

  private BooleanRetrievalCompressed2() {}
  ...
  public static void main(String[] args) throws Exception {
    ToolRunner.run(new BooleanRetrievalCompressed2(), args);
  }
}
